...
users:[
  {
    ...
    password:bcryptjs.hashSync("panteraloca",10),
    role:"admin"
  },
  {
  ...
  },
  {
    ...
    name:"Laura García",
    password:bcryptjs.hashSync("password3",10),
    role:"user"
  },
  {
    email:"carlos@gmail.com",
    name:"Carlos Pérez",
    password:bcryptjs.hashSync("password4",10),
    role:"user"
  },
  {
    email:"ana@gmail.com",
    name:"Ana Torres",
    password:bcryptjs.hashSync("password5",10),
    role:"user"
  },
  {
    email:"luis@gmail.com",
    name:"Luis Fernández",
    password:bcryptjs.hashSync("password6",10),
    role:"user"
  },
  {
    email:"sofia@gmail.com",
    name:"Sofía Jiménez",
    password:bcryptjs.hashSync("password7",10),
    role:"user"
  },
  {
    email:"diego@gmail.com",
    name:"Diego Ruiz",
    password:bcryptjs.hashSync("password8",10),
    role:"user"
  },
  {
    email:"valeria@gmail.com",
    name:"Valeria Morales",
    password:bcryptjs.hashSync("password9",10),
    role:"user"
  },
  {
    email:"pablo@gmail.com",
    name:"Pablo Ramírez",
    password:bcryptjs.hashSync("password10",10),
    role:"user"
  },
],
  ...
  products: [
    ...
    {
      description:
        "Designed for fit, comfort and style, the limited edition S3XY Tee is made from 100% cotton with a 3D silicone-printed XY logo across the chest. Made in Peru. Available in black.",
