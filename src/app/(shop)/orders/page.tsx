        ...
        <table className="min-w-full">
          ...
          <tbody>
            ...
            <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
              ...
              <td className="flex items-center text-sm  text-gray-900 f px-6 py-4 whitespace-nowrap">

                <IoCardOutline className="text-green-800" />
                <span className='mx-2 text-green-800 font-semibold'>Pagada</span>
            ...
            <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
              ...
              <td className="text-sm text-gray-900 font- px-6 ">
                <Link href="/orders/123" className="hover:underline">
                  Ver orden
                </Link>
              </td>
